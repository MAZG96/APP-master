...
public class Estructura2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estructura2);
        mRequestQueue = Volley.newRequestQueue(this);
        mostrar_preguntas();
        //TITULO TOOLBAR
        Toolbar barra = (Toolbar) findViewById(R.id.toolbarp);
        barra.setTitle("Estructura 2: "+getIntent().getStringExtra("nombre")+" "+getIntent().getStringExtra("apellidos"));
...
// Creamos un ArrayList de preguntas
    ...
    public void mostrar_preguntas() {
        String url = "https://playasconil.es/tfg/selectAllJSON.php?seccion=4";
