...
public class VisceralActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visceral);

        mRequestQueue = Volley.newRequestQueue(this);
        //TITULO TOOLBAR
        Toolbar barra = (Toolbar) findViewById(R.id.toolbarp);
        barra.setTitle("Visceral: "+getIntent().getStringExtra("nombre")+" "+getIntent().getStringExtra("apellidos"));
...
// Creamos un ArrayList de preguntas
    ...
    public void mostrar_preguntas() {
        String url = "https://playasconil.es/tfg/selectAllJSON.php?seccion=5";
