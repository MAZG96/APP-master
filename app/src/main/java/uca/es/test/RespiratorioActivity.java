...
public class RespiratorioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barra.setTitle("Sis. Respiratorio: "+getIntent().getStringExtra("nombre")+" "+getIntent().getStringExtra("apellidos"));
...
// Creamos un ArrayList de preguntas
    ...
    public void mostrar_preguntas() {
        String url = "https://playasconil.es/tfg/selectAllJSON.php?seccion=6";
