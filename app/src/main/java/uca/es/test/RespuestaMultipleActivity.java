...
public class RespuestaMultipleActivity extends AppCompatActivity {
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            String id_paciente = getIntent().getStringExtra("id_paciente");
                            mAdapter = new RespuestaMultipleAdapter(RespuestaMultipleActivity.this, respuestas,id_paciente,respondidas);
