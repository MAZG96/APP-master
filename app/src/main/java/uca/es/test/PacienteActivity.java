...
// JSON PARSE STRING
        ...
        bAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PacienteActivity.this, NuevoPacienteActivity.class);
                startActivity(intent);
            }
        });

        final PacienteAdapter pacientesAdapter = new PacienteAdapter(pacientes);
